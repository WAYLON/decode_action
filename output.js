//Tue Apr 08 2025 17:25:13 GMT+0000 (Coordinated Universal Time)
...
(async () => {
  ...
  for (let _0x53ae5e = 0; _0x53ae5e < _0x3c339c.length; _0x53ae5e++) {
    const _0x5f0b12 = _0x3c339c[_0x53ae5e].split("#")[0],
      _0x239552 = _0x3c339c[_0x53ae5e].split("#")[1];
    if (!_0x5f0b12 || !_0x239552) {
      logAndNotify("账号【" + (_0x53ae5e + 1) + "】 bnhg_ck格式错误");
      continue;
    }
    const _0x4ec87d = n(),
      _0x5d8cc9 = await sendGetRequest("https://cloud.banu.cn/api/member/statistic?member_id=" + _0x239552, _0x5f0b12, _0x239552, _0x4ec87d);
...
function n() {
  var _0x1cabf0 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 16,
    _0x25b157 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 36,
    _0xc3278e = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split(""),
    _0x2818c4 = [],
    _0x1c499f = 0;
...
function f() {
  const _0x159a77 = {
    ...
    _0x20fff6 = Object.assign || function (_0x54c3d0) {
    ...
    _0x40dbff = Object.keys(_0x4e17e1).reduce((_0x1d2275, _0x1190fb) => {
      _0x1190fb !== "app_secret" && (_0x1d2275[_0x1190fb] = _0x4e17e1[_0x1190fb]);
      return _0x1d2275;
    }, {}),
    _0x5d8b1d = md5(md5(Object.values(_0x4e17e1).join(""))).split("").reverse().join("");
...
function enc_data(_0x1a0fc0) {
  re = function (_0x5cffdc) {
    try {
      var _0x3de445 = neg(),
        _0x2ae99a = reg(_0x5cffdc, CryptoJS.enc.Utf8.parse("bfc5e947cd84c7ced1ee48d28fb3e90f"), CryptoJS.enc.Utf8.parse(_0x3de445));
      return {
...
function Env(_0x50903b, _0x4d3ada) {
  ...
  return new class {
    ...
    loaddata() {
      ...
      }
      {
        ...
        const _0x10d647 = this.path.resolve(this.dataFile),
          _0x4edce9 = this.path.resolve(process.cwd(), this.dataFile),
          _0xaf682b = this.fs.existsSync(_0x10d647),
          _0x51de74 = !_0xaf682b && this.fs.existsSync(_0x4edce9);
    ...
    writedata() {
      if (this.isNode()) {
        ...
        const _0x4ff7bf = this.path.resolve(this.dataFile),
          _0x2c8a12 = this.path.resolve(process.cwd(), this.dataFile),
          _0x4029f3 = this.fs.existsSync(_0x4ff7bf),
          _0x7f2877 = !_0x4029f3 && this.fs.existsSync(_0x2c8a12),
          _0x27618e = JSON.stringify(this.data);
    ...
    lodash_get(_0x387dd0, _0x45d9f9, _0x361bf1) {
      ...
      for (const _0x1bd348 of _0xbde5de) if (_0x34b45c = Object(_0x34b45c)[_0x1bd348], void 0 === _0x34b45c) {
        return _0x361bf1;
      }
      return _0x34b45c;
    }
    ...
    getdata(_0x10aeb1) {
      ...
      if (/^@/.test(_0x10aeb1)) {
        const [, _0x438c96, _0x509712] = /^@(.*?)\.(.*?)$/.exec(_0x10aeb1),
          _0x3b0b55 = _0x438c96 ? this.getval(_0x438c96) : "";
        if (_0x3b0b55) {
          try {
    ...
    setdata(_0x3c5626, _0x162873) {
      ...
      if (/^@/.test(_0x162873)) {
        const [, _0x3b6720, _0x3f09e8] = /^@(.*?)\.(.*?)$/.exec(_0x162873),
          _0x216dca = this.getval(_0x3b6720),
          _0xf5c6bf = _0x3b6720 ? "null" === _0x216dca ? null : _0x216dca || "{}" : "{}";
        try {
    ...
    setval(_0x57a276, _0x1207ee) {
      return this.isSurge() || this.isLoon() ? $persistentStore.write(_0x57a276, _0x1207ee) : this.isQuanX() ? $prefs.setValueForKey(_0x57a276, _0x1207ee) : this.isNode() ? (this.data = this.loaddata(), this.data[_0x1207ee] = _0x57a276, this.writedata(), !0) : this.data && this.data[_0x1207ee] || null;
    }
    initGotEnv(_0x9510dd) {
      this.got = this.got ? this.got : require("got");
      this.cktough = this.cktough ? this.cktough : require("tough-cookie");
      this.ckjar = this.ckjar ? this.ckjar : new this.cktough.CookieJar();
      _0x9510dd && (_0x9510dd.headers = _0x9510dd.headers ? _0x9510dd.headers : {}, void 0 === _0x9510dd.headers.Cookie && void 0 === _0x9510dd.cookieJar && (_0x9510dd.cookieJar = this.ckjar));
    }
        ...
        if ("object" == typeof _0x4673d1) {
          if (this.isLoon()) {
            let _0x342812 = _0x4673d1.openUrl || _0x4673d1.url || _0x4673d1["open-url"],
              _0x4cc506 = _0x4673d1.mediaUrl || _0x4673d1["media-url"];
            return {
              openUrl: _0x342812,
              mediaUrl: _0x4cc506
            };
          ...
          if (this.isQuanX()) {
            let _0x239779 = _0x4673d1["open-url"] || _0x4673d1.url || _0x4673d1.openUrl,
              _0x12ea34 = _0x4673d1["media-url"] || _0x4673d1.mediaUrl;
            return {
              "open-url": _0x239779,
              "media-url": _0x12ea34
            };
    ...
    wait(_0x958c3a) {
      ...
      const _0x2414b6 = new Date().getTime(),
        _0xc9b67a = (_0x2414b6 - this.startTime) / 1000;
...
function checkVersion(_0xd2422c, _0x4722b3) {
  try {
    ...
    const _0x109b68 = SyncRequest("GET", "https://bus.yxrong.cn/api/update/check?fileName=" + _0xd2422c + "&fileMd5=" + _0x4722b3),
      _0x328cd3 = JSON.parse(_0x109b68.getBody("utf8"));
